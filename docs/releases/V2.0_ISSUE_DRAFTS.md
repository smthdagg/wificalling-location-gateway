...
WLOC supervisor, one control plane, per-device profiles, resource
...
## V2-03 — Add per-profile WLOC/redirect runtime
...
Unify WLOC events into a bounded, searchable and supportable logging
