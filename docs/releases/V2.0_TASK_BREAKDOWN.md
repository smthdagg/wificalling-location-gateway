...
- architecture-correct OpenWrt cross-build and signed package checksums must be
  recorded for the final release artifact; host-side packaging contracts pass;
