...
return view.extend({
	...
	render: function(data) {
		...
		function geoRows(s) {
			var g = s.geo || {};
			var deviceLabel = s.assigned_device || '-';
			var exitVal = '-';
			...
			return [
				...
				E('tr', { class: 'tr' }, [E('td', { class: 'td' }, wlocI18n.t('WLOC target device')), E('td', { class: 'td' }, deviceLabel), E('td', { class: 'td right' }, refreshIpBtn(s))]),
